...
class FixedArgumentParser(ArgumentParser):
    ...
    def _parse_known_args(self, arg_strings, namespace):
        ...
        for mutex_group in self._mutually_exclusive_groups:
            group_actions = (
                mutex_group._group_actions  # pylint: disable=protected-access
            )
        ...
        for group in self._mutually_exclusive_groups:
            if group.required:
                for (
                    action
                ) in group._group_actions:  # pylint: disable=protected-access
                ...
                # if no actions were used, report the error
                    ...
                    self.error(msg % " ".join(filter(None, names)))
